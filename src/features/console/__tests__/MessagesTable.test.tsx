/**
 * Issue #24 Ticket 1: bare Messages table component tests. Drives
 ...
 * order, empty state, and row expansion (PRD §6 formatting, including one
 * array-field message and one char[]-field message per the ticket's
 * acceptance criteria).
 */
...
describe('MessagesTable', () => {
  it('shows the empty state when nothing has been recorded', () => {
    render(<MessagesTable inspector={new MessageAggregateStore()} />)
  ...
  it('renders one row per message type, sorted alphabetically by name', () => {
    ...
    render(<MessagesTable inspector={inspector} />)
